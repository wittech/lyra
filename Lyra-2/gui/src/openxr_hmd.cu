...
void OpenXRHMD::init_create_xr_instance() {
	...
	strncpy(instance_create_info.applicationInfo.applicationName, "Lyra-2 GUI v" NGP_VERSION, XR_MAX_APPLICATION_NAME_SIZE);
	instance_create_info.applicationInfo.applicationVersion = 1;
	strncpy(instance_create_info.applicationInfo.engineName, "Lyra-2 GUI v" NGP_VERSION, XR_MAX_ENGINE_NAME_SIZE);
