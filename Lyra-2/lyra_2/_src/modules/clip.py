...
from lyra_2._src.modules.attention import attention
from lyra_2._src.modules.conditioner import AbstractEmbModel
from lyra_2._src.modules.umt5 import HuggingfaceTokenizer
from lyra_2._src.modules.xlm_roberta import XLMRoberta
...
def load_model_torch(model, ckpt_path):
    ...
    if distributed.is_rank0():
        ckpt = easy_io.load(
            ckpt_path, map_location="cpu", fast_backend=False, weights_only=True
        )
...
class CLIPModel:
    def __init__(
        ...
        self.model = load_model_torch(self.model, checkpoint_path)
